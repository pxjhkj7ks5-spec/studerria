...
У дашборді біля налаштувань Telegram є «Тестове повідомлення»: перевірка підключення та приклади INFO, WATCH, WARNING, HIGH, RESOLVED. Тести позначені як вигадані, надсилаються лише у власний підключений чат через звичайну чергу, працюють під час паузи та обмежені шістьма за хвилину. Додавання до черги ще не підтверджує доставку Telegram.
