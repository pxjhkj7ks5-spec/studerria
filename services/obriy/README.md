...
## Цивільні оголошення каналів

Додано публічний збір оголошень із трьох каналів, явні підписки на міста/райони, збереження правок і окрему чергу цивільних повідомлень. За замовчуванням — пробний режим без розсилки. Немає відновлення переміщень із контексту. [Правила, обмеження та ввімкнення](docs/civil-bulletins.md).
