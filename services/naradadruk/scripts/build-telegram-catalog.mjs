...
const productDefinitions = [
  ...
  { postId: 47, title: "Двоколірний настільний органайзер", slug: "dvokolirnyi-nastilnyi-organaizer", categorySlug: "dekor", basePrice: 335, isFeatured: true },
  { postId: 50, title: "Муляж гранати M67", slug: "muliazh-granaty-m67", categorySlug: "strajkbol", basePrice: 275 },
  { postId: 52, title: "Підставка під Glock 17 Gen 4/5", slug: "pidstavka-glock-17", categorySlug: "strajkbol", basePrice: 220, isFeatured: true },
  { postId: 55, title: "Кріплення GoPro на шолом FAST", slug: "kriplennia-gopro-fast", categorySlug: "strajkbol", basePrice: 110, isFeatured: true },
