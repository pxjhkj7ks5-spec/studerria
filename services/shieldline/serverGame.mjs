...
const missions = [
  campaignMission("first-contact", "Перший контакт", 15, 38, 18, [["parodiya",2,75],["gerbera",3,180],["geran2",2,390],["parodiya",2,570],["gerbera",2,600],["geran2",3,780],["gerbera",2,860]]),
