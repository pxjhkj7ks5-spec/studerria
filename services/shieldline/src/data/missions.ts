...
import { ALL_LAUNCH_SECTOR_IDS, FIRST_NIGHT_LAUNCH_SECTOR_IDS, SECOND_NIGHT_LAUNCH_SECTOR_IDS } from "../game/launchSystem.mjs";
...
export const campaignMissions: MissionDefinition[] = [
  {
    ...
    waves: [
      ...
      { id: "wave-02", index: 2, threatKind: "iskander", originSector: "north", targetSector: "north", etaSeconds: 52, size: 3, difficulty: 62 },
