...
const unitDefinitionsBase: Array<Omit<UnitDefinition, "roleClass" | "doctrine" | "sensorProfile" | "missionReserveCapacity">> = [
  ...
  },
  {
    ...
    outerAccuracy: 52,
    engagementMode: "kinetic",
    engagementChanceByThreat: chances({ drone: 38, geran2: 42, cruise: 84, ballistic: 62, iskander: 55, decoy: 0 }),
    mobility: 1,
    readiness: 76,
  ...
  },
  {
    ...
    outerAccuracy: 42.3,
    engagementMode: "kinetic",
    engagementChanceByThreat: chances({ drone: 62, cruise: 88, ballistic: 0, decoy: 0 }),
    mobility: 1,
    readiness: 78,
  ...
  },
  {
    ...
    outerAccuracy: 41.4,
    engagementMode: "kinetic",
    engagementChanceByThreat: chances({ drone: 58, cruise: 84, ballistic: 0, decoy: 0 }),
    mobility: 1,
    readiness: 80,
  ...
  },
  {
    ...
    outerAccuracy: 55,
    engagementMode: "kinetic",
    engagementChanceByThreat: chances({ drone: 32, cruise: 62, ballistic: 94, iskander: 90, decoy: 0 }),
    mobility: 1,
    readiness: 76,
