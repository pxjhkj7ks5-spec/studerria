...
export const campaignMissionsPlan: CampaignMissionDefinition[] = [
  { id: "first-contact", index: 1, title: "Перший контакт", durationMinutes: 15, focusRegion: "Столичний кластер", grant: 38, rewardCap: 52, objective: "Навчитися виявляти, класифікувати й пріоритезувати загрози без марної витрати дорогого БК.", expectedThreatClasses: ["Parody", "Gerbera", "Shahed", "Cruise"], broadAzimuth: "північ, північний схід і південний схід", unlocks: ["radar", "mvg", "manpads"], waves: [
  ...
  { id: "southern-corridor", index: 2, title: "Південний коридор", durationMinutes: 35, focusRegion: "Південний портовий кластер", grant: 32, rewardCap: 82, objective: "Передислокувати частину мережі на новий театр, не оголюючи попередній рубіж.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise"], broadAzimuth: "морський південь і південний схід", unlocks: ["boat", "ew", "gepard", "drone-operators"], waves: [
  ...
  { id: "mass-night", index: 5, title: "Масована ніч", durationMinutes: 60, focusRegion: "Столичний кластер", grant: 100, rewardCap: 283, objective: "Застосувати всю збережену мережу, економіку, БК і передислокації у фінальній комбінованій атаці.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "північ, північний схід і схід", unlocks: ["patriot"], waves: [
