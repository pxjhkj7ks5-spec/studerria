...
export const campaignRouteTemplates: CampaignRouteTemplate[] = [
  ...
  { id: "R31", launchSector: "SE1", preferredLaunchSectorIds: ["long_range_air_a"], primaryRegion: "Східний промисловий кластер", targetCityId: "dnipro", allowedThreats: ["kh101"], ballistic: false, baseWaypoints: [P(46.4, 48.0), P(46.0, 43.4), P(47.2, 39.2), P(47.7, 36.8), P(48.46, 35.05)], diversionChance: .04, mergeCompatible: ["R25"], difficultyWeight: 4 },
  ...
  { id: "R35", launchSector: "E1", preferredLaunchSectorIds: ["long_range_air_a"], primaryRegion: "Столичний кластер", targetCityId: "kyiv", allowedThreats: ["kh101"], ballistic: false, baseWaypoints: [P(46.4, 48.0), P(48.0, 43.2), P(49.0, 38.7), P(49.7, 34.2), P(50.45, 30.52)], diversionChance: .05, mergeCompatible: ["R20", "R32"], difficultyWeight: 5 },
...
export const campaignMissionsPlan: CampaignMissionDefinition[] = [
  ...
  { id: "southern-corridor", index: 2, title: "Південний коридор", durationMinutes: 35, focusRegion: "Південний портовий кластер", grant: 32, objective: "Передислокувати мережу до південного узбережжя, відбити морську крилату атаку й зустріти фінальний балістичний удар.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "Чорне море, Крим, Приазов’я і південний балістичний напрямок", briefing: "Після оборони Києва противник переносить тиск на Одесу та морську логістику. Підготуйте катер і Gepard проти дронів, збережіть С-300 для Kalibr та фінального швидкісного контакту.", unlocks: ["boat", "gepard"], waves: [
    w("02:00", "gerbera", 4, ["R10", "R30"], 1, "none", "Портовий", .25, 70, "low"), w("06:00", "parodiya", 5, ["R10", "R14"], 2, "splitFeint", "Портовий / логістичний", .4, 60, "low"), w("11:00", "geran2", 4, ["R12", "R15"], 2, "rallyMerge", "Портовий", 0, 50, "medium"), w("15:30", "gerbera", 3, ["R13"], 3, "screenForNext", "Портовий", 0, 25, "low"), w("16:00", "geran2", 6, ["R10", "R12"], 3, "rallyMerge", "Портовий", 0, 55, "high"), w("21:30", "parodiya", 3, ["R14"], 1, "diversionOnly", "Логістичний", 1, 40, "low"), w("23:00", "kalibr", 1, ["R33", "R34"], 1, "independent", "Портовий", 0, 0, "veryHigh"), w("28:00", "geran2", 8, ["R11", "R15"], 5, "corridorMerge", "Портовий", .15, 65, "high"), w("32:30", "gerbera", 2, ["R30"], 1, "falseTerminal", "Південний вузол", 1, 20, "low"), w("33:00", "geran2", 5, ["R13"], 5, "fullGroup", "Портовий", 0, 30, "high"), w("34:15", "iskander", 1, ["R27"], 1, "independent", "Портовий", 0, 0, "critical"),
  ] },
  { id: "eastern-arc", index: 3, title: "Східна дуга", durationMinutes: 45, focusRegion: "Східний промисловий кластер", grant: 48, objective: "Утримати Дніпро під багатовісною атакою, розвести дешевий і середній ешелони та пережити повторний балістичний фінал.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "Ростовський, Приазовський, морський і балістичний напрямки", briefing: "Тиск переходить на Дніпро. Дронові коридори прикривають Kalibr і X-101, а фінальний швидкісний удар перевірить, чи зберегли ви ракети С-300 після південної операції.", unlocks: ["long-radar", "buk", "s300"], waves: [
    w("03:00", "parodiya", 6, ["R07", "R21"], 3, "splitIntoTwoArcs", "Промисловий / резерв", .33, 60, "low"), w("08:00", "geran2", 6, ["R07", "R09"], 3, "rallyMerge", "Промисловий", 0, 45, "medium"), w("13:30", "gerbera", 4, ["R08"], 2, "screenForCruise", "Промисловий", 0, 30, "low"), w("14:00", "geran2", 4, ["R08"], 2, "trailDecoys", "Промисловий", 0, 35, "medium"), w("20:00", "kalibr", 1, ["R36"], 1, "independent", "Промисловий", 0, 0, "veryHigh"), w("24:30", "parodiya", 4, ["R21", "R20"], 2, "falseCommit", "Резерв / столичний", .5, 45, "low"), w("25:00", "geran2", 10, ["R07", "R08"], 6, "corridorMerge", "Промисловий", .1, 80, "high"), w("31:00", "kh101", 2, ["R24", "R31"], 1, "independent", "Прикордонний / промисловий", .5, 20, "veryHigh"), w("36:30", "gerbera", 3, ["R09"], 3, "leadScreen", "Промисловий", 0, 25, "low"), w("37:00", "geran2", 10, ["R07", "R09"], 8, "hardMerge", "Промисловий", 0, 60, "high"), w("42:00", "geran2", 8, ["R08"], 8, "fullGroup", "Промисловий", 0, 35, "critical"), w("43:30", "iskander", 1, ["R28"], 1, "independent", "Промисловий", 0, 0, "critical"),
  ] },
  { id: "saturation", index: 4, title: "Насичення", durationMinutes: 50, focusRegion: "Північно-східний прикордонний кластер", grant: 70, objective: "Пережити перевантаження сенсорів, дві балістичні атаки й комбінований фінал без виснаження верхнього ешелону.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "Бєлгородський і Воронезький напрямки", briefing: "Харків атакують серіями: приманки відкривають коридори для Geran-2, крилатих і двох балістичних ударів. IRIS-T та NASAMS мають звільнити С-300 для найшвидших цілей.", unlocks: ["iris-t", "nasams"], waves: [
  ...
  { id: "mass-night", index: 5, title: "Масована ніч", durationMinutes: 60, focusRegion: "Столичний кластер", grant: 100, objective: "Застосувати всю збережену мережу, економіку, БК і передислокації у фінальній безперервній комбінованій атаці.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "усі основні пускові напрямки", briefing: "Фінальна ніч повертає кампанію до Києва. Загрози йдуть з усіх освоєних коридорів; Patriot прикриває балістику, а решта мережі повинна витримати дрони й крилаті ракети без довгих пауз.", unlocks: ["patriot"], waves: [
