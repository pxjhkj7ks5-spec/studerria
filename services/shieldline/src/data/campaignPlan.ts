...
export const campaignMissionsPlan: CampaignMissionDefinition[] = [
  ...
  { id: "eastern-arc", index: 3, title: "Східна дуга", durationMinutes: 45, focusRegion: "Східний промисловий кластер", grant: 48, objective: "Витримати змішані хвилі, розвести дешевий і середній ешелони та берегти ракетний резерв.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise"], broadAzimuth: "Ростовський, Приазовський і повітряний напрямки", unlocks: ["long-radar", "buk", "s300"], waves: [
