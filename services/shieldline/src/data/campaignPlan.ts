...
export const campaignRouteTemplates: CampaignRouteTemplate[] = [
  ...
  { id: "R31", launchSector: "SE1", preferredLaunchSectorIds: ["astrakhan_air_corridor"], primaryRegion: "Східний промисловий кластер", targetCityId: "dnipro", allowedThreats: ["kh101"], ballistic: false, baseWaypoints: [P(46.4, 48.0), P(46.0, 43.4), P(47.2, 39.2), P(47.7, 36.8), P(48.46, 35.05)], diversionChance: .04, mergeCompatible: ["R25"], difficultyWeight: 4 },
  { id: "R32", launchSector: "SE1", preferredLaunchSectorIds: ["caspian_air_corridor"], primaryRegion: "Столичний кластер", targetCityId: "kyiv", allowedThreats: ["kh101"], ballistic: false, baseWaypoints: [P(44.8, 47.2), P(45.8, 42.5), P(47.5, 38.0), P(49.2, 34.0), P(50.45, 30.52)], diversionChance: .05, mergeCompatible: ["R20", "R35"], difficultyWeight: 5 },
  { id: "R33", launchSector: "S1", preferredLaunchSectorIds: ["black_sea_launch_box"], primaryRegion: "Південний портовий кластер", targetCityId: "odesa", allowedThreats: ["kalibr"], ballistic: false, baseWaypoints: [P(43.9, 32.8), P(44.3, 31.6), P(44.8, 30.5), P(45.46, 30.73)], diversionChance: .03, mergeCompatible: ["R23", "R34"], difficultyWeight: 4 },
  { id: "R34", launchSector: "S1", preferredLaunchSectorIds: ["novorossiysk_black_sea"], primaryRegion: "Південний портовий кластер", targetCityId: "odesa", allowedThreats: ["kalibr"], ballistic: false, baseWaypoints: [P(44.7, 37.8), P(44.1, 35.3), P(44.5, 32.7), P(45.46, 30.73)], diversionChance: .04, mergeCompatible: ["R13", "R33"], difficultyWeight: 4 },
  { id: "R35", launchSector: "E1", preferredLaunchSectorIds: ["astrakhan_air_corridor"], primaryRegion: "Столичний кластер", targetCityId: "kyiv", allowedThreats: ["kh101"], ballistic: false, baseWaypoints: [P(46.4, 48.0), P(48.0, 43.2), P(49.0, 38.7), P(49.7, 34.2), P(50.45, 30.52)], diversionChance: .05, mergeCompatible: ["R20", "R32"], difficultyWeight: 5 },
  { id: "R36", launchSector: "S1", preferredLaunchSectorIds: ["black_sea_launch_box", "novorossiysk_black_sea"], primaryRegion: "Східний промисловий кластер", targetCityId: "dnipro", allowedThreats: ["kalibr"], ballistic: false, baseWaypoints: [P(43.9, 34.0), P(45.0, 34.1), P(46.2, 34.0), P(47.3, 34.2), P(48.46, 35.05)], diversionChance: .04, mergeCompatible: ["R25"], difficultyWeight: 5 },
];
...
export const campaignMissionsPlan: CampaignMissionDefinition[] = [
  { id: "first-contact", index: 1, title: "Перший контакт", durationMinutes: 15, focusRegion: "Столичний кластер", grant: 38, objective: "Навчитися виявляти, класифікувати й пріоритезувати загрози без марної витрати дорогого БК.", expectedThreatClasses: ["Parody", "Gerbera", "Shahed", "Cruise"], broadAzimuth: "північ, північний схід і південний схід", unlocks: ["radar", "mvg", "manpads"], waves: [
    ...
    w("10:30", "kh101", 1, ["R31"], 1, "independent", "Південно-східний кластер", 0, 0, "veryHigh"),
  ...
  { id: "southern-corridor", index: 2, title: "Південний коридор", durationMinutes: 35, focusRegion: "Південний портовий кластер", grant: 32, objective: "Передислокувати частину мережі на новий театр, не оголюючи попередній рубіж.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise"], broadAzimuth: "морський південь і південний схід", unlocks: ["boat", "ew", "gepard", "drone-operators"], waves: [
  ...
  { id: "eastern-arc", index: 3, title: "Східна дуга", durationMinutes: 45, focusRegion: "Східний промисловий кластер", grant: 48, objective: "Витримати щільні групи Shahed і перші повноцінні decoy + cruise оркестровки.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise"], broadAzimuth: "схід і південний схід", unlocks: ["buk", "s300"], waves: [
    w("03:00", "parodiya", 6, ["R07", "R21"], 3, "splitIntoTwoArcs", "Промисловий / резерв", .33, 60, "low"), w("08:00", "geran2", 6, ["R07", "R09"], 3, "rallyMerge", "Промисловий", 0, 45, "medium"), w("13:30", "gerbera", 4, ["R08"], 2, "screenForCruise", "Промисловий", 0, 30, "low"), w("14:00", "geran2", 4, ["R08"], 2, "trailDecoys", "Промисловий", 0, 35, "medium"), w("20:00", "kalibr", 1, ["R36"], 1, "independent", "Промисловий", 0, 0, "veryHigh"), w("24:30", "parodiya", 4, ["R21", "R20"], 2, "falseCommit", "Резерв / столичний", .5, 45, "low"), w("25:00", "geran2", 10, ["R07", "R08"], 6, "corridorMerge", "Промисловий", .1, 80, "high"), w("31:00", "kh101", 2, ["R24", "R31"], 1, "independent", "Прикордонний / промисловий", .5, 20, "veryHigh"), w("36:30", "gerbera", 3, ["R09"], 3, "leadScreen", "Промисловий", 0, 25, "low"), w("37:00", "geran2", 10, ["R07", "R09"], 8, "hardMerge", "Промисловий", 0, 60, "high"), w("42:00", "geran2", 8, ["R08"], 8, "fullGroup", "Промисловий", 0, 35, "critical"),
  ] },
  { id: "saturation", index: 4, title: "Насичення", durationMinutes: 50, focusRegion: "Північно-східний прикордонний кластер", grant: 70, objective: "Пережити перевантаження сенсорів і першу балістичну перевірку верхнього ешелону.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "східний прикордонний сектор", unlocks: ["iris-t", "nasams"], waves: [
  ...
  { id: "mass-night", index: 5, title: "Масована ніч", durationMinutes: 60, focusRegion: "Столичний кластер", grant: 100, objective: "Застосувати всю збережену мережу, економіку, БК і передислокації у фінальній комбінованій атаці.", expectedThreatClasses: ["Decoy", "Shahed", "Cruise", "Ballistic"], broadAzimuth: "північ, північний схід і схід", unlocks: ["patriot"], waves: [
