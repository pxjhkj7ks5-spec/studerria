...
const en = {
  ...
  "catalog.lead": "Plan the defense, command each night, and review the same authoritative battle stream.",
  ...
  "mission.1": "Night 01: Signal Window", "mission.2": "Night 02: Blackout Relay", "mission.3": "Night 03: Last Reserve",
  ...
  "replay.title": "Tactical replay", "replay.hint": "Move the timeline to inspect the operation.", "replay.restart": "Replay from launch warning",
...
const uk: Record<TranslationKey, string> = {
  ...
  "catalog.lead": "Сплануйте оборону, керуйте кожною ніччю та переглядайте той самий авторитетний потік бою.",
  ...
  "mission.1": "Ніч 01: Сигнальне вікно", "mission.2": "Ніч 02: Релейне затемнення", "mission.3": "Ніч 03: Останній резерв",
  ...
  "replay.title": "Тактичний повтор", "replay.hint": "Переміщуйте шкалу, щоб переглянути перебіг операції.", "replay.restart": "Повторити від попередження про пуск",
...
const ru: Record<TranslationKey, string> = {
  ...
  "catalog.lead": "Спланируйте оборону, командуйте каждой ночью и просматривайте единый авторитетный поток боя.",
  ...
  "mission.1": "Ночь 01: Сигнальное окно", "mission.2": "Ночь 02: Релейное затемнение", "mission.3": "Ночь 03: Последний резерв",
  ...
  "replay.title": "Тактический повтор", "replay.hint": "Перемещайте шкалу, чтобы изучить операцию.", "replay.restart": "Повторить с предупреждения о пуске",
