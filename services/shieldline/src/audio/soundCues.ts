...
export const soundCueDefinitions: Record<SoundCue, SoundCueDefinition> = {
  ...
  "engagement.gun": combat([sfx("gun-burst-1", { gain: 0.52 })], 260, 3),
  "engagement.missile": combat([sfx("missile-launch", { duration: 2.2, gain: 0.48 })], 520, 3),
  ...
  "result.intercept": combat([sfx("intercept-impact", { gain: 0.42 })], 450, 3),
  ...
  "result.impact": critical([sfx("city-impact", { gain: 0.48 })], 1_000),
