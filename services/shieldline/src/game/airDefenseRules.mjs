...
const doctrine = (values = {}) => ({
  ...
  allowManualOverride: false, salvoPolicy: "single", cheapFirstPolicy: false,
  networkRequired: true, coastalOnly: false, ...values,
});

export const AIR_DEFENSE_RULES_VERSION = "3.1.0";
