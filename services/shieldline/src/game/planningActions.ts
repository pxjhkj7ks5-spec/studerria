...
export const planningActionDefinitions: PlanningActionDefinition[] = [
  {
    id: "high-alert",
    title: "Підвищена готовність",
    description: "Покращує виявлення цього циклу, але збільшує витрати енергії та втому установок.",
    cooldownDays: 1,
    cost: { energy: 4 },
  },
  {
    id: "conserve-ammo",
    title: "Берегти боєкомплект",
    description: "Зменшує витрати БК, але погіршує ймовірність перехоплення.",
    cooldownDays: 0,
    cost: {},
  },
  {
    id: "emergency-aid",
    title: "Запит термінової допомоги",
    description: "Витрачає політичний ресурс заради відкладеного поповнення бюджету та БК.",
    cooldownDays: 3,
    cost: { political: 12 },
  },
  {
    id: "energy-repair",
    title: "Ремонт енергосистеми",
    description: "Витрачає бюджет на відновлення енергетики країни та міст.",
    cooldownDays: 1,
    cost: { budget: 16 },
  },
  {
    id: "morale-campaign",
    title: "Підтримка моралі",
    description: "Підвищує мораль населення ціною бюджету та політичного ресурсу.",
    cooldownDays: 2,
    cost: { budget: 10, political: 8 },
  },
  {
    id: "rapid-redeployment",
    title: "Швидке передислокування",
    description: "Дозволяє активніше переміщувати мобільні установки, але збільшує втому.",
    cooldownDays: 2,
    cost: { budget: 8 },
  },
  {
    id: "intelligence-focus",
    title: "Посилена розвідка",
    description: "Покращує визначення загроз у наступному циклі атаки.",
    cooldownDays: 1,
    cost: { budget: 12 },
  },
];
