...
const letterParagraphs = [
  ...
  `мені подобається що ти не поверхнева людина, не один настрій і не одна роль. у тобі є і ніжність, і характер, і та впертість, яка іноді може бісити, але без неї це була б вже не ти. і я правда вірю, що ти зможеш зробити собі життя таким, щоб самій було кайфово в ньому жити, а не просто "нормально".`,
