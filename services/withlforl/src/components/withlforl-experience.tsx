    ...
    replies: [
      {
        author: "баланс",
        handle: "@andriimrch",
        text: "Ти весела, серйозна і дуже розумна. З тобою цікаво говорити про все.",
      },
      {
        author: "вдячність",
        handle: "@andriimrch",
        text: "З тобою тепло навіть мовчки. Дякую, що зробила цей рік щасливішим.",
      },
    ],
    likeCount: "18",
...
const letterParagraphs = [
  ...
  `мені подобається що ти не поверхнева людина, не один настрій і не одна роль. у тобі є і ніжність, і характер, і та впертість, яка іноді може бісити, але без неї це була б вже не ти. і я правда вірю, що ти зможеш зробити собі життя таким, щоб самій було кайфово в ньому жити, а не просто проживати.`,
    ...
    <section className="date-invite-view" aria-label="Date invitation">
      ...
      <article className="date-card">
        ...
        <div className="date-copy">
          ...
          <p>
            пропоную жоске побачення, я ж маю все ж таки себе поадруваати, і я
            хочу тобі подарувати прижмний вечір в компанії зі мною. Кіно на твий
            вибір на схилі протасового в вечір коли буде зручно
          </p>
        </div>
        ...
        <p className={answer === "yes" ? "date-result is-win" : "date-result"} aria-live="polite">
          {answer === "yes" ? (
            <>
              ура перемога, перемога 15 червня
