...
function buildSessionGeneratorReturnHref(
  ...
  if (Object.prototype.hasOwnProperty.call(payload, 'explicit_dates_json')) {
    const explicitDates = parseIsoDateList(payload.explicit_dates_json, 366);
    if (explicitDates.length) {
      params.set('explicit_dates_json', JSON.stringify(explicitDates));
    }
  }
