        ...
        items: [
          {
            ...
            answer: isUk
              ? 'Найчастіше бракує звʼязки між викладачем, предметом і курсом. У зверненні вкажіть предмет, курс і що саме зламалось: оцінки, attendance, рейтинг або доступ до subject journal.'
              : 'Most often the teacher-subject-course mapping is incomplete. Include the subject, course, and the broken layer: grades, attendance, rating, or journal access.',
          },
          {
            question: isUk ? 'Де шукати published rating або attendance signal?' : 'Where do I find the published rating or attendance signal?',
            answer: isUk
              ? 'Останній published rating залишається в рейтингу журналу, але той самий snapshot дублюється на My Day і в message surfaces. Attendance редагується в журналі, а на головній показується стислий health signal.'
              : 'The latest published rating stays in Journal Rating, but the same snapshot is echoed in My Day and message surfaces. Attendance stays editable in the journal while the homepage shows a compact health signal.',
          },
        ],
      },
      {
