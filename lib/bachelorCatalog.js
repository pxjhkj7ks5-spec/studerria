...
const BACHELOR_CATALOG_PLACEMENT_OVERRIDES = Object.freeze({
  ...
  '2.2.1.': Object.freeze({ suggested_stage_number: 3, suggested_term_numbers: [1, 3] }),
...
function normalizeBachelorCatalogEntry(rawEntry = {}, sourceKey = DEFAULT_BACHELOR_CATALOG_SOURCE_KEY) {
  ...
  const subjectDefaults = YEAR2_SUBJECT_DEFAULTS[sourceCode] || YEAR3_SUBJECT_DEFAULTS[sourceCode];
  return {
