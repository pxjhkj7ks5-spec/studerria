...
// Confirmed from the approved 2026-2027 year-1 timetable and curator input.
const YEAR1_SUBJECT_DEFAULTS = Object.freeze({
  '1.1.1.': [2, true, 'seminar_only'],
  '1.1.2.': [3, true, 'seminar_only'],
  '1.1.3.': [2, true, 'lecture_practice'],
  '1.1.4.': [2, true],
  '1.1.5.': [2, true],
  '1.1.6.': [2, true],
  '1.1.7.': [2, true],
  '1.1.9.': [2, true],
  'schedule.2026.year1.political-thought': [2, true],
});

// Confirmed year-2 timetable configuration; the academic-language year-1 row stays unchanged.
const YEAR2_SUBJECT_DEFAULTS = Object.freeze({
  '1.1.16.': [3, true, 'seminar_only'],
  '1.1.18.': [2, true],
  '1.1.22.': [2, true],
  '1.1.18.1.': [2, true],
  '1.1.20.': [2, true],
  '2.1.3.1.': [1, false],
  'schedule.2026.political-psychology': [1, false],
  '2.2.1.1.': [2, false, 'seminar_only'],
  '2.2.1.2.': [1, false],
  '2.2.2.': [1, false],
});

// Confirmed from the approved 2026-2027 year-3 timetable and curator input.
// Munich remains a separate campus group and is not counted in Kyiv subgroup totals.
const YEAR3_SUBJECT_DEFAULTS = Object.freeze({
  '1.1.23.': [2, true],
  '1.1.24.': [2, true],
  '1.1.25.': [2, true],
  '1.1.26.': [2, true],
  ...
  '2.1.2.3.': [1, false],
  '2.1.3.3.': [1, false],
  'schedule.2026.year3.spanish': [2, false, 'seminar_only'],
  'schedule.2026.year3.german': [1, false, 'seminar_only'],
});
...
const BACHELOR_CATALOG_PLACEMENT_OVERRIDES = Object.freeze({
  // Year 2, term 1 follows the approved 2026-2027 timetable. Other terms stay intact.
  '1.1.16.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [1, 2] }),
  '1.1.17.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [] }),
  '1.1.20.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [1, 2] }),
  '2.1.1.1.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [] }),
  '2.1.2.1.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [] }),
  '2.1.4.1.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [] }),
  '2.2.1.1.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [1, 2] }),
  '2.2.1.2.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [1, 2] }),
  '2.2.2.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [1, 2] }),
  '2.2.5.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [] }),
  '1.1.9.': Object.freeze({ suggested_stage_number: 1, suggested_term_numbers: [1, 2] }),
  // Year 3, term 1 follows the approved 2026-2027 Kyiv timetable.
  '1.1.28.': Object.freeze({ suggested_stage_number: 3, suggested_term_numbers: [2] }),
  '2.1.1.3.': Object.freeze({ suggested_stage_number: 3, suggested_term_numbers: [] }),
  '2.1.4.3.': Object.freeze({ suggested_stage_number: 3, suggested_term_numbers: [] }),
  '2.2.8.': Object.freeze({ suggested_stage_number: 3, suggested_term_numbers: [] }),
...
const RAW_BACHELOR_CATALOG_SOURCES = [
  {
    ...
    entries: [
      { source_code: '1.1.1.', template_name: 'Українська мова за професійним спрямуванням. Академічне письмо і публічні виступи', display_title: 'Українська мова за профільним спрямуванням. Академічне письмо і публічні виступи', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 1, suggested_term_numbers: [1], entry_kind: 'subject' },
      ...
      { source_code: '1.1.7.', template_name: 'Історія великих ідей (формат дискусійного клубу)', display_title: 'Історія великих ідей', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 1, suggested_term_numbers: [1], entry_kind: 'subject' },
      ...
      { source_code: '1.1.9.', template_name: 'Публічна політика та публічна дипломатія', display_title: 'Публічна політика і публічна дипломатія', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 1, suggested_term_numbers: [2], entry_kind: 'subject' },
      ...
      { source_code: '1.1.18.1.', template_name: 'Соціологія', display_title: 'Соціологія', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 2, suggested_term_numbers: [1], entry_kind: 'subject', default_group_count: 2 },
      ...
      { source_code: '1.1.23.', template_name: 'Стратегічні комунікації та GR - технології', display_title: 'Стратегічні комунікації і GR', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      { source_code: '1.1.24.', template_name: 'Міжнародна торгівля. Міжнародні фінанси', display_title: 'Міжнародний бізнес. Міжнародні фінанси', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      ...
      { source_code: '1.1.26.', template_name: 'Міжнародне публічне право. Міжнародне економічне право', display_title: 'Міжнародне публічне право. Міжнародне економічне право, англійською', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      { source_code: '1.1.27.', template_name: 'Статистика. Кількісні та якісні методи дослідження у соціальних науках', display_title: 'Соціологія. Кількісні та якісні методи дослідження у поведінкових науках', source_section: '1.1. Обов\'язкові освітні компоненти', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      ...
      { source_code: '2.1.2.3.', template_name: 'Політичні системи країн Латинської Америки і Карибського басейну', display_title: 'Політичні системи країн ЛАКБ', source_section: '2.1. Дисципліни професійної  та практичної підготовки', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      ...
      // Confirmed in the 2026-2027 year-2 schedule; no official curriculum code is supplied.
      { source_code: 'schedule.2026.political-psychology', template_name: 'Політична психологія та нейромаркетинг', display_title: 'Політична психологія та нейромаркетинг', source_section: 'Розклад 2026-2027', suggested_stage_number: 2, suggested_term_numbers: [1], entry_kind: 'subject', default_group_count: 1, default_flags: { is_required: false } },
      // Year-3 language choices reuse the canonical language templates but have their own term placement.
      { source_code: 'schedule.2026.year3.spanish', template_name: 'Іспанська мова', display_title: 'Іспанська мова', source_section: 'Розклад 2026-2027', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      { source_code: 'schedule.2026.year3.german', template_name: 'Німецька мова', display_title: 'Німецька мова', source_section: 'Розклад 2026-2027', suggested_stage_number: 3, suggested_term_numbers: [1], entry_kind: 'subject' },
      { source_code: 'schedule.2026.year1.political-thought', template_name: 'Політична думка і теорія міжнародних відносин', display_title: 'Політична думка і теорія міжнародних відносин', source_section: 'Розклад 2026-2027', suggested_stage_number: 1, suggested_term_numbers: [1], entry_kind: 'subject' },
    ],
  },
];
...
function normalizeBachelorCatalogEntry(rawEntry = {}, sourceKey = DEFAULT_BACHELOR_CATALOG_SOURCE_KEY) {
  ...
  const subjectDefaults = YEAR1_SUBJECT_DEFAULTS[sourceCode]
    || YEAR2_SUBJECT_DEFAULTS[sourceCode]
    || YEAR3_SUBJECT_DEFAULTS[sourceCode];
  return {
    ...
    default_group_count: normalizeBachelorCatalogGroupCount(subjectDefaults ? subjectDefaults[0] : rawEntry.default_group_count),
    default_flags: {
      ...DEFAULT_BACHELOR_CATALOG_FLAGS,
      ...(rawEntry.default_flags && typeof rawEntry.default_flags === 'object' ? rawEntry.default_flags : {}),
      ...(subjectDefaults ? { is_required: subjectDefaults[1] } : {}),
    },
    default_activity_preset: cleanText((subjectDefaults && subjectDefaults[2]) || rawEntry.default_activity_preset || 'lecture_seminar', 40).toLowerCase() || 'lecture_seminar',
