...
const YEAR2_SUBJECT_DEFAULTS = Object.freeze({
  'schedule.2026.academic-foreign-language': [3, true, 'seminar_only'],
  '1.1.18.': [2, true],
  '1.1.22.': [2, true],
  '1.1.18.1.': [2, true],
  '1.1.20.': [2, true],
...
const BACHELOR_CATALOG_PLACEMENT_OVERRIDES = Object.freeze({
  ...
  '1.1.16.': Object.freeze({ suggested_stage_number: 2, suggested_term_numbers: [2] }),
...
const RAW_BACHELOR_CATALOG_SOURCES = [
  {
    ...
    entries: [
      ...
      { source_code: 'schedule.2026.academic-foreign-language', template_name: 'Академічна іноземна мова', display_title: 'Академічна іноземна мова', source_section: 'Розклад 2026-2027', suggested_stage_number: 2, suggested_term_numbers: [1], entry_kind: 'subject', default_group_count: 3 },
...
function normalizeBachelorCatalogEntry(rawEntry = {}, sourceKey = DEFAULT_BACHELOR_CATALOG_SOURCE_KEY) {
  ...
  const subjectDefaults = YEAR2_SUBJECT_DEFAULTS[sourceCode];
  return {
