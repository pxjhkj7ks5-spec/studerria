...
function normalizeBachelorCatalogEntry(rawEntry = {}, sourceKey = DEFAULT_BACHELOR_CATALOG_SOURCE_KEY) {
  ...
  return {
    ...
    source_code: cleanText(rawEntry.source_code, 80),
    ...
    suggested_stage_number: normalizePositiveInt(rawEntry.suggested_stage_number),
    suggested_term_numbers: normalizeTermNumbers(rawEntry.suggested_term_numbers || []),
