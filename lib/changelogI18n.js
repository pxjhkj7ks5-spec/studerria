const changelogTextEnMap = new Map([
  ['Додано демо-режим для перегляду основних сторінок без реєстрації.', 'Demo mode was added for exploring core pages without registration.'],
  ['Розширено демо-навігацію та узгоджено перемикання мови.', 'Demo navigation was expanded and language switching was synchronized.'],
  ['Покращено розміщення основних сторінок на широких екранах.', 'Core page placement was improved on wide screens.'],
