...
for key in OSINT_DB_OWNER_PASSWORD OSINT_DB_PASSWORD OSINT_GATEWAY_SECRET; do
...
chmod 600 "$env_path"
echo 'OSINT database and gateway secrets are ready. GitHub token is configured separately.'
